...
//       <div>
//         <h1 className="text-2xl font-bold text-white">Player Segments</h1>
//         <p className="text-gray-400 text-sm mt-1">Explore and target player groups for campaigns</p>
//       </div>
...
//           className="w-full bg-gray-900 border border-gray-700 rounded-lg pl-9 pr-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
//         />
//       </div>
